...
namespace QuizApp
{
    class CreatedTestLayout
    {
        ...
        //--------------------------------------------------------------------------------------------
        public CreatedTestLayout(string question, string qA, string qB, string qC, string qAns, string qMark, string tTitle, string tDesc, string tTotal)
        {
